...
require_once Google::path() . 'Auth/OpenID/Consumer.php';
require_once Google::path() . 'Auth/OpenID/FileStore.php';
require_once Google::path() . 'Auth/OpenID/SReg.php';
require_once Google::path() . 'Auth/OpenID/PAPE.php';
