...
require_once Google::path() . "Auth/OpenID/BigMath.php";
require_once Google::path() . "Auth/OpenID/DiffieHellman.php";
require_once Google::path() . "Auth/OpenID/KVForm.php";
require_once Google::path() . "Auth/OpenID/TrustRoot.php";
require_once Google::path() . "Auth/OpenID/ServerRequest.php";
