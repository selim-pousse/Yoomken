 ...
 */
require_once Google::path() . "Auth/OpenID.php";
require_once Google::path() . "Auth/OpenID/Message.php";
require_once Google::path() . "Auth/OpenID/HMAC.php";
require_once Google::path() . "Auth/OpenID/Association.php";
require_once Google::path() . "Auth/OpenID/CryptUtil.php";
require_once Google::path() . "Auth/OpenID/DiffieHellman.php";
require_once Google::path() . "Auth/OpenID/KVForm.php";
require_once Google::path() . "Auth/OpenID/Nonce.php";
require_once Google::path() . "Auth/OpenID/Discover.php";
require_once Google::path() . "Auth/OpenID/URINorm.php";
require_once Google::path() . "Auth/Yadis/Manager.php";
require_once Google::path() . "Auth/Yadis/XRI.php";
